...
$cert_dir = "../images/certificates/ethics-certificate/";
$cert_ext = "jpg"; // fallback
$cert_type = "image";

if (file_exists($cert_dir . "certificate-ethics.pdf")) {
    $cert_ext = "pdf";
    $cert_type = "pdf";
} elseif (file_exists($cert_dir . "certificate-ethics.png")) {
    $cert_ext = "png";
}

$certificateImagePath = $cert_dir . "certificate-ethics." . $cert_ext . "?v=" . time();
$downloadFileName = "Ethics_Certificate_" . htmlspecialchars($submission['control_number']) . "." . $cert_ext;
?>
...
<div class="max-w-5xl mx-auto pb-12 pt-6 transition-colors duration-200">
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 print:hidden">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Official Ethics Clearance Document</p>
        </div>
