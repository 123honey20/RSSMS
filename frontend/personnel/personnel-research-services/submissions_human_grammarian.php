...
<div class="bg-white dark:bg-warmdark-panel p-6 rounded-xl shadow-sm min-h-[80vh] border border-transparent dark:border-warmdark-border transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
        ...
        <select id="syFilter" class="w-full border border-gray-300 dark:border-warmdark-border rounded-lg px-4 py-2 text-sm bg-white dark:bg-warmdark-bg focus:ring-2 focus:ring-blue-900 dark:focus:ring-blue-500 focus:outline-none shadow-sm text-gray-700 dark:text-gray-200 font-medium transition-colors">
        ...
        fetch(`../../backend/ajax/fetch_human_grammarian_submissions.php?p=${page}&search=${encodeURIComponent(search)}&status=${encodeURIComponent(status)}&sy=${encodeURIComponent(sy)}&dept=${encodeURIComponent(pDept)}`)
            ...
            .then(data => {
                ...
                data.submissions.forEach(row => {
                    ...
                    let badgeColor = "btext-gray-500 dark:text-gray-400"; 
