...
<div class="max-w-6xl mx-auto bg-white dark:bg-warmdark-panel rounded-2xl shadow-lg p-8 space-y-8 border border-transparent dark:border-warmdark-border transition-colors duration-200">
    ...
    <div>
        ...
        <?php else: ?>
            <div class="bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 p-4 rounded-lg border border-red-100 dark:border-red-900/30 transition-colors">
                File not found.
            </div>
        <?php endif; ?>
    </div>
...
<div id="commentModal"
    ...
    <div class="bg-white dark:bg-warmdark-panel w-[500px] max-w-[95%] rounded-xl shadow-xl p-6 space-y-4 border border-transparent dark:border-warmdark-border transition-colors">
        ...
        <div id="commentError" class="hidden text-red-600 dark:text-red-400 text-sm mt-2">
            Please complete all fields.
        </div>

        <div id="commentCounter" class="text-sm text-gray-500 dark:text-gray-400">
        ...
        <div>
            ...
            <input type="number" id="commentPage"
                class="w-full mt-1 border border-gray-300 dark:border-warmdark-border rounded-lg px-3 py-2 text-sm bg-white dark:bg-warmdark-bg text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors">
        </div>
        ...
        <div class="flex justify-end gap-3 pt-3 border-t border-gray-100 dark:border-warmdark-border mt-2 transition-colors">
            ...
            <button onclick="closeCommentModal()"
                class="px-4 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 hover:underline transition-colors">
                Cancel
            </button>

            <button id="saveCommentBtn"
                class="bg-blue-600 dark:bg-blue-700 text-white px-5 py-2 rounded-lg text-sm hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
                Done
            </button>
        </div>
    ...
    <div class="bg-white dark:bg-warmdark-panel w-[600px] max-w-[95%] rounded-xl shadow-xl p-6 space-y-4 border border-transparent dark:border-warmdark-border transition-colors">
        ...
        <div class="flex justify-end pt-3 border-t border-gray-100 dark:border-warmdark-border transition-colors">
            <button onclick="closeViewCommentModal()"
                class="bg-gray-800 dark:bg-gray-700 text-white px-5 py-2 rounded-lg text-sm hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors">
                Close
            </button>
        </div>
