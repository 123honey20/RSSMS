...
$stmt = $conn->prepare("
    SELECT h.id, h.file_path, h.status, s.control_number, h.result_file_path, p.full_name as assigned_personnel
...
$resultRelativePath = $resultFile ? "/RSSMS/uploads/human_grammarian_results/" . $resultFile : null;
...
// -------------------------------------------------------------
// FIX: STATUS NORMALIZER
// Catches old 'Rejected' statuses or accidentally blank rows 
// from your database update and forces them to 'Needs Revision'
// -------------------------------------------------------------
