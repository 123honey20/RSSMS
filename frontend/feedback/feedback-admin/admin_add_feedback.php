<div class="max-w-6xl mx-auto pb-12 transition-colors duration-200" x-data="academicRubricBuilder()">
    ...
    <div class="bg-white dark:bg-warmdark-panel rounded-t-xl shadow-sm border border-gray-200 dark:border-warmdark-border border-b-0 px-6 py-5 mt-4 transition-colors">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex-1 w-full">
                <label class="block text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Evaluation Instrument Title</label>
    ...
    <div class="bg-gray-50 dark:bg-warmdark-bg p-6 md:p-8 rounded-b-2xl shadow-inner border border-gray-200 dark:border-warmdark-border transition-colors">

        <template x-for="(criterion, cIndex) in criteria" :key="cIndex">
            <div class="bg-white dark:bg-warmdark-panel rounded-xl shadow-sm border border-gray-200 dark:border-warmdark-border overflow-hidden relative group transition-colors mb-6">
                ...
                <div class="bg-blue-900/5 dark:bg-blue-900/10 px-6 py-4 border-b border-gray-100 dark:border-warmdark-border flex items-center justify-between transition-colors">
                    ...
                    <div class="flex items-center gap-4">
                        <div class="flex items-center gap-2 bg-white dark:bg-warmdark-bg px-3 py-1.5 rounded-lg border border-gray-200 dark:border-warmdark-border shadow-sm transition-colors">
                            ...
                            <input type="number" x-model.number="criterion.weight" class="w-16 border-none p-0 text-right font-bold text-blue-900 dark:text-blue-400 bg-transparent focus:ring-0" placeholder="0">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <button @click="addLevel(cIndex)" class="text-xs font-bold text-blue-700 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 flex items-center gap-1 bg-blue-50 dark:bg-blue-900/30 px-3 py-1.5 rounded-md transition border border-transparent dark:border-blue-900/50">
    ...
    <div class="mt-6 flex items-center justify-end gap-4">
        <a href="admin_dashboard.php?page=feedback_admin_view" class="px-6 py-2.5 rounded-lg text-sm font-bold text-gray-600 dark:text-gray-300 bg-transparent hover:bg-gray-100 dark:hover:bg-warmdark-hover transition">
            Cancel
        </a>
        <button @click="saveRubric" class="bg-blue-900 dark:bg-blue-800 text-white px-8 py-2.5 rounded-lg text-sm font-bold hover:bg-blue-800 dark:hover:bg-blue-700 transition shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2" :disabled="totalWeight !== 100 || !rubricName.trim()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
