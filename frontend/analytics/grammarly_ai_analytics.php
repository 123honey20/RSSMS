    ...
    <div class="mb-2 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 tracking-tight">Grammarly & AI Analytics</h2>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Comprehensive overview of submissions, receipts, and feedback for the current school year.</p>
        </div>
    </div>
