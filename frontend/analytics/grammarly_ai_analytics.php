...
<div class="space-y-6">
    <div class="mb-2 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3">
                <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Grammarly & AI Analytics</h2>
                <span class="bg-blue-100 text-blue-800 text-xs font-bold px-2.5 py-1 rounded-md">SY <?= htmlspecialchars($active_sy) ?></span>
            </div>
            <p class="text-sm text-gray-500 mt-1">Comprehensive overview of submissions, receipts, and feedback for the current school year.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-100 transition-all duration-300 flex items-center justify-between group">
            <div>
                <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Total Documents</p>
                <p class="text-3xl font-bold text-gray-900 tracking-tight"><?= $total_docs ?></p>
            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-yellow-200 transition-all duration-300 flex items-center justify-between group">
            <div>
                <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Document Pending Review</p>
                <p class="text-3xl font-bold text-gray-900 tracking-tight"><?= $doc_status['Pending'] ?></p>
            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-purple-200 transition-all duration-300 flex items-center justify-between group">
            <div>
                <p class="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Receipts Pending</p>
                <p class="text-3xl font-bold text-gray-900 tracking-tight"><?= $rec_status['Receipt Uploaded'] ?></p>
            </div>
            <div class="w-12 h-12 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center group-hover:bg-purple-600 group-hover:text-white transition-colors duration-300 shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-green-200 transition-all duration-300 flex items-center justify-between group">
            <div class="flex-1">
                ...
                <div class="flex items-center gap-4">
                    <div>
                        <p class="text-2xl font-bold text-gray-900 leading-none tracking-tight"><?= $total_ratings ?></p>
                        <p class="text-[10px] text-gray-500 uppercase font-bold mt-1">Ratings</p>
                    </div>
                    <div class="w-px h-8 bg-gray-200"></div>
                    <div>
                        <p class="text-2xl font-bold text-gray-900 leading-none tracking-tight"><?= $total_comments ?></p>
                        <p class="text-[10px] text-gray-500 uppercase font-bold mt-1">Reviews</p>
                    </div>
                </div>
            </div>
            <div class="w-12 h-12 rounded-xl bg-green-50 text-green-600 flex items-center justify-center group-hover:bg-green-600 group-hover:text-white transition-colors duration-300 shrink-0 ml-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
            <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider self-start mb-4">Document Status</h3>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center">
            <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider self-start mb-4">Receipt Status</h3>
            <div class="relative w-full max-w-[220px] aspect-square">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-5 border-b border-gray-100">
            <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Recent Document Submissions</h3>
        </div>
        ...
        new Chart(document.getElementById('feedbackChart').getContext('2d'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: '#facc15', // Yellow/Gold for stars
                    borderRadius: 4,
                    barThickness: 15
                }]
            },
