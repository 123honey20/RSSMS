...
$recent_query = $conn->query("
    SELECT s.control_number, s.thesis_title, z.status, z.round, z.uploaded_at
    FROM statistician z 
    JOIN students s ON z.student_id = s.id 
    WHERE s.school_year = '$safe_sy'
...
<div class="space-y-6">
    <div class="mb-2 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3">
                <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Statistician Analytics</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-5 border-b border-gray-100">
            <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Recent Statistician Submissions</h3>
        </div>
