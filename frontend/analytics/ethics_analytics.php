...
<div class="space-y-6">
    <div class="mb-2 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-3">
                <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Ethics Analytics</h2>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-5 border-b border-gray-100">
            <h3 class="text-sm font-bold text-gray-700 uppercase tracking-wider">Recent Ethics Submissions</h3>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-600">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if($recent_query && $recent_query->num_rows > 0): ?>
                        ...
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="5" class="px-6 py-8 text-center text-gray-400">No recent document submissions for this school year.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    new Chart(document.getElementById('feedbackChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderRadius: 4,
                barThickness: 20 // Slightly thicker bars since it spans 2 columns
            }]
        },
        options: {
            ...
            scales: {
                x: { beginAtZero: true, grid: { borderDash: [4, 4], color: '#f3f4f6' }, ticks: { precision: 0 } },
    ...
    new Chart(document.getElementById('roundBuildingChart').getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderRadius: { topLeft: 8, topRight: 8 }, // Modern "building roof" look
                borderSkipped: false,
                barThickness: 45
            }]
        },
        options: {
            responsive: true, maintainAspectRatio: false,
            scales: {
                y: { beginAtZero: true, grid: { borderDash: [4, 4], color: '#f3f4f6' }, ticks: { precision: 0 } },
