...
<div class="max-w-4xl mx-auto py-6 px-4 w-full">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Ethics Service Verification</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-green-100 overflow-hidden">
        ...
        <div class="p-6 bg-white border-t border-gray-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                ...
                <a href="student_dashboard.php?page=student_certificate_ethics&id=<?php echo $submissionId; ?>" class="group flex items-center p-4 border border-gray-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 hover:shadow-sm transition-all cursor-pointer text-left">
                ...
                <a href="student_dashboard.php?page=student_feedback_ethics&id=<?php echo $submissionId; ?>" class="group flex items-center p-4 border border-gray-200 rounded-xl hover:border-blue-400 hover:bg-blue-50 hover:shadow-sm transition-all cursor-pointer text-left">
                    <div class="w-12 h-12 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center shrink-0 mr-4 group-hover:scale-105 transition-transform">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                        ...
                        <span class="block text-gray-500 text-xs mt-0.5 leading-snug">Evaluate the personnel who assisted you.</span>
                    </div>
                </a>
