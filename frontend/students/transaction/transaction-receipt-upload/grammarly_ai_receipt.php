...
if (!$transaction) {
    echo "<div class='max-w-4xl mx-auto py-8 px-4'><div class='p-6 text-red-600 bg-red-50 rounded-lg'>Transaction not found.</div></div>";
    exit();
}
...
<div class="max-w-4xl mx-auto py-8 px-4 w-full">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Upload Transaction Receipt</h1>
            <p class="text-sm text-gray-500 mt-1">Submit your payment receipt for Round <?php echo $round; ?>.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <div class="mb-8 p-5 bg-blue-50/50 border border-blue-100 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-800">Receipt Details (Round <?php echo $round; ?>)</h3>
                    <p class="text-xs text-gray-500 mt-0.5">Please ensure your receipt is clear and readable.</p>
                </div>
            </div>
            
            <?php
                $badgeColor = "bg-gray-100 text-gray-700";
                if ($status === 'No Receipt') $badgeColor = "bg-gray-100 text-gray-700";
                if ($status === 'Receipt Uploaded') $badgeColor = "bg-yellow-100 text-yellow-700";
        ...
        <?php if ($canUpload): ?>
            <form action="../../backend/actions/upload-receipt/upload_grammarly_ai_receipt.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm(event)">
                ...
                <div class="mb-8">
                    <label class="block text-sm font-medium text-gray-700 mb-3">Select your receipt file</label>
        ...
        <?php else: ?>
            <div class="flex flex-col items-center justify-center p-8 bg-gray-50 border border-gray-200 rounded-2xl">
                ...
                <h3 class="text-lg font-bold text-gray-800 mb-2">Upload Disabled</h3>
