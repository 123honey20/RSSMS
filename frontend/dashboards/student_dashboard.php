        ...
        <aside class="fixed left-0 top-[72px] w-64 h-[calc(100vh-72px)] bg-white border-r border-gray-200 flex flex-col z-40 overflow-y-auto custom-scrollbar">
            ...
            <nav class="flex-1 py-5 flex flex-col gap-4">
                ...
                <div x-data="{ open: true }">
                    ...
                    <div x-show="open" class="flex flex-col gap-0.5 px-3" x-cloak>
                        <a href="student_dashboard.php?page=chat_grammarly_ai" class="flex items-center gap-3 px-2.5 py-1.5 rounded-md text-[13px] font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors group">
                            <div class="w-2 h-2 rounded-full bg-emerald-400 shadow-sm ml-1"></div>
                            Grammarly & AI
                        </a>
                        <a href="student_dashboard.php?page=chat_ethics" class="flex items-center gap-3 px-2.5 py-1.5 rounded-md text-[13px] font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors group">
                            <div class="w-2 h-2 rounded-full bg-blue-400 shadow-sm ml-1"></div>
                            Ethics
                        </a>
                        <a href="student_dashboard.php?page=chat_human_grammarian" class="flex items-center gap-3 px-2.5 py-1.5 rounded-md text-[13px] font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors group">
                            <div class="w-2 h-2 rounded-full bg-purple-400 shadow-sm ml-1"></div>
                            Human Grammarian
                        </a>
                        <a href="student_dashboard.php?page=chat_librarian" class="flex items-center gap-3 px-2.5 py-1.5 rounded-md text-[13px] font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors group">
                            <div class="w-2 h-2 rounded-full bg-pink-400 shadow-sm ml-1"></div>
                            Librarian
                        </a>
                        <a href="student_dashboard.php?page=chat_statistician" class="flex items-center gap-3 px-2.5 py-1.5 rounded-md text-[13px] font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors group">
            ...
            <div class="p-4 border-t border-gray-100 mt-auto flex flex-col gap-1">
                ...
                <a href="student_dashboard.php?page=student_settings" class="flex items-center gap-3 px-3 py-2 rounded-md text-[13px] font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors">
