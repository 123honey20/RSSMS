...
$sub = $conn->query("SELECT * FROM librarian WHERE student_id = $student_id");
...
<div class="flex-1">
    ...
    <div class="p-6">
        ...
        <form action="../../backend/actions/upload-submission/upload_librarian.php" method="POST" enctype="multipart/form-data" class="space-y-4">
