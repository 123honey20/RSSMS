...
$sub = $conn->query("SELECT * FROM human_grammarian WHERE student_id = $student_id ORDER BY round DESC LIMIT 1");
...
<div class="max-w-4xl mx-auto py-8 px-4 w-full">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Human Grammarian Upload</h1>
            <p class="text-sm text-gray-500 mt-1">Submit your document to review by the Human Grammarian Personnel.</p>
        </div>
