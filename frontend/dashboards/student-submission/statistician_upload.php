...
$sub = $conn->query("SELECT * FROM statistician WHERE student_id = $student_id");
...
<div class="flex-1">
    ...
    <div class="p-6">
        ...
        <form action="../../backend/actions/upload-submission/upload_statistician.php" method="POST" enctype="multipart/form-data" class="space-y-4">
