...
if (move_uploaded_file($file['tmp_name'], $targetFile)) {
    ...
    if ($latest) {
        ...
        ");
            ...
            $stmt = $conn->prepare("
            INSERT INTO librarian (student_id, school_id, file_path, status, round) 
            VALUES (?, ?, ?, 'Pending', ?)
        ");
    ...
    header("Location: ../../../frontend/dashboards/student_dashboard.php?page=student_upload_librarian");
    exit();
} else {
