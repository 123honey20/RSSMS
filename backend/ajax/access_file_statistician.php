...
$stmt = $conn->prepare("UPDATE statistician SET status = ?, personnel_id = ? WHERE id = ?");
    ...
    try {
        ...
        $mail->Body = $header . "
            ...
            <div style='padding:30px;line-height:1.6;color:#334155;'>
                ...
                <p>This email confirms that you have processed a <strong>Statistician Review</strong> submission. Action summary:</p>
